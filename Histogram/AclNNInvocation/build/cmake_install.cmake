# Install script for directory: /home/HwHiAiUser/work/Histogram/AclNNInvocation/src
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/../output" TYPE EXECUTABLE FILES "/home/HwHiAiUser/work/Histogram/AclNNInvocation/output/execute_op")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/../output/execute_op" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/../output/execute_op")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/../output/execute_op"
...
file(WRITE "/home/HwHiAiUser/work/Histogram/AclNNInvocation/build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
